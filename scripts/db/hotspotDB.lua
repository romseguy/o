...
function hotspotDB:setup()
	...
	hotspotDB:addHotspot("0", "All", 40, 45, 327.81, -1959.99, 198.72);
	hotspotDB:addHotspot("Aerie Peak", "All", 40, 50, 327.81, -1959.99, 198.72);
	hotspotDB:addHotspot("QuelDanilLodge", "All", 40, 45, 266.941, -2751.41, 123.544);
	hotspotDB:addHotspot("Zun'watha", "All", 40, 50, -35.7245, -2479.51, 121.423);
	hotspotDB:addHotspot("Hiri'watha", "All", 40, 50, -21.24, -2804.51, 121.95);
	hotspotDB:addHotspot("AgolWatha", "All", 40, 50, 339.304, -3469.39, 119.433);
	hotspotDB:addHotspot("AltarOfZul", "All", 40, 50, -165.74, -3306.03, 123.36);
	hotspotDB:addHotspot("Seradene", "All", 40, 50, 724.846, -3996.11, 150.735);
	hotspotDB:addHotspot("SkulkRock", "All", 40, 50, 370.48, -3900.55, 131.46);
	hotspotDB:addHotspot("Rebel Camp", "All", 40, 45, -11311.5, -195.19, 77.3198);
	--hotspotDB:addHotspot("ShadraAlor", "All", 40, 45, -464.208, -2837.23, 111.07);
